...
class TestSessionControllerTest extends SapphireTest
{
    ...
    public function testStartNonGlobalImport(): void
    {
    ...
    public function testStartNonGlobalDefaultRecords(): void
    {
        $params = [
            'requireDefaultRecords' => '1',
        ];
    ...
    public function testSetNotRunning(): void
    {
    ...
    public function testClearNotRunning(): void
    {
        $this->expectException(LogicException::class);
        $params = [];
        Director::mockRequest(function ($request) {
    ...
    public function testClearRunning(): void
    {
    ...
    public function testEndNotRunning(): void
    {
        $this->expectException(LogicException::class);
        $params = [];
        Director::mockRequest(function ($request) {
    ...
    public function testEndRunning(): void
    {
        $params = [];
        Director::mockRequest(function ($request) {
            $controller = new TestSessionController();
